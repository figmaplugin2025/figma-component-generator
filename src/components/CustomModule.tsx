...
const CustomModule: React.FC<CustomModuleProps> = ({ className = '' }) => {
  return (
          ...
          <div className="custom__module--wrapper-container-content">
            ...
            <div className="custom__module--contents">
              <div className="custom__module--contents-wrapper">
                ...
                {/* Additional Input Wrappers (Collapsed) */}
                <div className="custom__module--contents-input-wrapper collapsed">
                  <div className="collapsed-indicator">&gt; .custom__module--contents-input-wrapper</div>
                </div>
                <div className="custom__module--contents-input-wrapper collapsed">
                  <div className="collapsed-indicator">&gt; .custom__module--contents-input-wrapper</div>
                </div>
            ...
            <div className="custom__module--actions">
              <div className="actions-content">
                {/* Actions content will be added here */}
              </div>
            </div>
